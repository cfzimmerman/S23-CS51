...
module IntStringListQueue : PRIOQUEUE with type elt = IntStringCompare.t =
  ListQueue (IntStringCompare)

module IntStringTreeQueue : PRIOQUEUE with type elt = IntStringCompare.t =
  TreeQueue (IntStringCompare)

module IntStringHeapQueue : PRIOQUEUE with type elt = IntStringCompare.t =
  BinaryHeap (IntStringCompare)

let tests () =
  print_endline "\nTesting BinSTree: IntTree";
  IntTree.run_tests ();

  print_endline "\nTesting BinSTree: IntStringTree";
  IntStringTree.run_tests ();

  print_endline "\nTesting ListQueue: IntListQueue";
  IntListQueue.run_tests ();

  print_endline "\nTesting ListQueue: IntStringListQueue";
  IntListQueue.run_tests ();

  print_endline "\nTesting TreeQueue: IntTreeQueue";
  IntTreeQueue.run_tests ();

  print_endline "\nTesting TreeQueue: IntStringTreeQueue";
  IntStringTreeQueue.run_tests ();

  print_endline "\nTesting BinaryHeap: IntHeapQueue";
  IntHeapQueue.run_tests ();

  print_endline "\nTesting BinaryHeap: IntStringHeapQueue";
  IntStringHeapQueue.run_tests ()
;;
