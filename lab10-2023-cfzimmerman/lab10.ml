...
let random_list (length : int) : int list =
  List.init length (fun _ -> Random.int 999) ;;
...
let time_sort (sort : int list -> int list) (lst : int list) : float =
  let (_, time) = Absbook.call_timed sort lst in time
;;
...
let insert_sort_lt = InsertSort.sort (<) ;;
let merge_sort_lt = MergeSort.sort (<) ;;


time_sort insert_sort_lt (random_list 1000) ;;
time_sort merge_sort_lt (random_list 1000) ;;
...
------------------------------------------------------------
Insertion Sort  | 0.0019073486328125   | 8.49199295043945312
------------------------------------------------------------
Merge Sort      | 0.0040531158447265625 | 1.61385536193847656
------------------------------------------------------------
 *)
...
let insert_sort_lt = InsertSort.sort (<) ;;
let delayed_merge_sort_lt = DelayMergeSort.sort (<) ;;


time_sort insert_sort_lt (random_list 2800) ;;
time_sort delayed_merge_sort_lt (random_list 2800) ;;
(*....................................................................
...
(*               |    List length 10    |  List length 1000
                 |    Time (seconds)    |  Time (seconds)
------------------------------------------------------------
Insertion Sort   | 0.0030994415283203125 | 8.92806053161621094
------------------------------------------------------------
Delay Merge Sort | 55.0730228424072266 | 55.9241771697998047
------------------------------------------------------------*)
...
let exercise6 = 2800    (* replace with the requested list size *)
...
let double_merge_sort_lt = DoubleMergeSort.sort (<) ;;

time_sort insert_sort_lt (random_list 75) ;;
time_sort double_merge_sort_lt (random_list 75) ;;
...
(*                |    List length 10    |  List length 1000
                  |    Time (seconds)    |  Time (seconds)
------------------------------------------------------------
Insertion Sort    | 0.00286102294921875 | 8.54706764221191406
------------------------------------------------------------
Double Merge Sort | 0.0069141387939453125 | 1.35517120361328125
------------------------------------------------------------*)

(* Now record a list length for which you found DoubleMergeSort sorted
faster than InsertSort. *)
   
let exercise7 = 75    (* replace with the requested list size *)
...
than InsertSort. *)
let exercise8 = 70    (* replace with the requested list size *)
